...
| `dedi_sendPrintsToClient`                        | Whether the dedicated server should forward all logs to connected clients. Useful for testing/debugging on a dedicated server                                                                  | `0`                            | `0-1`                                              |
