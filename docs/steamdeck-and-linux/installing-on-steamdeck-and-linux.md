...
2. Install the latest version of Northstar using [Viper](https://github.com/R2Northstar/NorthstarWiki/blob/main/docs/installing-northstar/northstar-installers.md#0negal-viper) or do it manually
