...
We recommend keeping your Fedora instance up to date, which can be done manually by running `sudo dnf update` inside of your Fedora instance, or creating this script utilizing `systemd`.
