...
If your controller isn't working on Northstar, there are a couple way you can make it work via Steam's controller settings.
...
If you _don't_ own Titanfall 2 on Steam, you'll want to add it as a Non-Steam game and launch the added game via Steam./
